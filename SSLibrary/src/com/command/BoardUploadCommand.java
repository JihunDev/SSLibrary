...
public class BoardUploadCommand {
	private int id;
	private String u_id;
	private int counter;
	...
	public String toString() {
		return "BoardUploadCommand [id=" + id + ", u_id=" + u_id + ", counter="
				+ counter + ", title=" + title + ", content=" + content
				+ ", reg_date=" + reg_date + ", sort=" + sort + ", file_name="
				+ file_name + ", reg_number=" + reg_number + "]";
	}
}
