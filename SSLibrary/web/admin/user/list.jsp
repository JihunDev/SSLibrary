...
<div class="listtabletitle" style="height:150px">	
	<table class="table" style="width:100%;">
		<tr>
			<th><h1>Library Member List</h1></th>
		</tr>
	</table>	
</div>
...
<form class="form-inline">
	 ...
	 <button class="btn btn-default btn-sm btncolor" style="width:auto;float:right;margin:0 2px;" type="button" onclick="searchByName(this.form)">검색</button>
   	<input type="text" id="name" name="name"  style="float:right;width:150px;margin:0 0 0 2px;"class="form-control input-sm" placeholder="Search for...">
     	<select class="form-control input-sm" style="width:80px;float:right;" name="isadmin">
		...
		<table class="table table-hover theadcolor">
			...
			%>
					<tr>
						...
						<td class="hidden-xs">${u.isadmin}</td>
					</tr>
			<%}%>
				</c:forEach>
			</tbody>
...
<a class="btn btn-default btn-sm btncolor" href="usersearch.do?${search}pageno=1"><span class="glyphicon glyphicon-backward"></span></a>
<a class="btn btn-default btn-sm btncolor" href="usersearch.do?${search}pageno=<%=prev_pageno%>"> <span class="glyphicon glyphicon-triangle-left"></span></a>
<%
if(page_eno == 0){
...
<a class="btn btn-default btn-sm btncolor" href="usersearch.do?${search}pageno=<%=next_pageno%>"><span class="glyphicon glyphicon-triangle-right"></span></a>
<a class="btn btn-default btn-sm btncolor" href="usersearch.do?${search}pageno=<%=total_page%>"><span class="glyphicon glyphicon-forward"></span></a>
</div>
	</div></div>