...
public class SeatLogCommand {
	...
	public SeatLogCommand() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public SeatLogCommand(int id, String u_id, int s_id, String start_date,
	...
	// INSERT : U_ID, S_ID
	public SeatLogCommand(String u_id, int s_id) {
		super();
		this.u_id = u_id;
		this.s_id = s_id;
	}
	...
	// UPDATE(¿¬Àå, ¹İ³³): U_ID
	public SeatLogCommand(String u_id) {
		super();
		this.u_id = u_id;
	}
