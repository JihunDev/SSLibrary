...
<div class="fieldsetform">
	<form class="form-inline">
		...
		<div class="input-group">
			<input type="text" id="search" name="search"
				...
				<button class="btn btn-default btn-sm" type="button"
					onclick="getBoard(this.form);">검색</button>
			</span>
		</div>
		<!-- /input-group -->
		...
		<fieldset>
			...
			<hr>
			<a href="boardmain.do?${search}sort=<%=sort%>&pageno=1">[맨앞으로]</a> <a
				href="boardmain.do?${search}sort=<%=sort%>&pageno=<%=prev_pageno%>">[이전]</a>
			<%
				if (page_eno == 0) {
 ...
 %>
			...
			<a
				href="boardmain.do?${search}sort=<%=sort%>&pageno=<%=next_pageno%>">[다음]</a>
